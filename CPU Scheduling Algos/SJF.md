...
Wisit this website for [SRTF](https://www.geeksforgeeks.org/shortest-remaining-time-first-srtf-with-predicted-time/) and [SJF](https://www.geeksforgeeks.org/program-for-shortest-job-first-or-sjf-cpu-scheduling-set-1-non-preemptive/)
